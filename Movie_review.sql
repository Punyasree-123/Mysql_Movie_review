...
-- movie genres and the best movie in the genre based on the maximum avgerage review rating. 
-- The result should have the following columns- genre|title|stars
-- Rating of the movie in star format, record format is a repeating numbers of stars from 1 to 5
...
(1, 4.5),(1, 4.0),(1, 5.0),(2, 4.2),
(2, 4.8),(2, 3.9),(3, 4.6),(3, 3.8),
(3, 4.3),(4, 4.1),(4, 3.7),(4, 4.4),
(5, 3.9),(5, 4.5),(5, 4.2),(6, 4.8),
(6, 4.7),(6, 4.9),(7, 4.6),(7, 4.9),
(7, 4.3),(8, 4.9),(8, 5.0),(8, 4.8),
(9, 4.7),(9, 4.9),(9, 4.5),(10, 4.6),
(10, 4.3),(10, 4.7),(11, 3.9),(11, 4.0),
(11, 3.5),(12, 3.7),(12, 3.8),(12, 4.2),
(13, 3.2),(13, 3.5),(13, 3.8),(14, 3.8),
(14, 4.0),(14, 4.2),(15, 3.9),(15, 4.0),(15, 4.1);

with cte as 
(SELECT m.genre,m.title,avg(r.rating) as avg_rating,
DENSE_RANK () OVER (PARTITION BY m.genre ORDER BY avg(r.rating) desc) as rn
FROM movies as m
JOIN reviews as r
ON m.id=r.movie_id
